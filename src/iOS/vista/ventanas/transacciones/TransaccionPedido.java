...
public class TransaccionPedido extends JDialog {
	/**
	 * 
	 */
	...
	private TransaccionPedidoControlador controlador;
	...
	public TransaccionPedido() {
		...
		LabelPersonalizado lblprsnlzdMetrosDelPedido = new LabelPersonalizado(0);
		...
		LabelPersonalizado lblprsnlzdTotalAPagar = new LabelPersonalizado(0);
		lblprsnlzdTotalAPagar.setBounds(970, 309, 120, 15);
		getContentPane().add(lblprsnlzdTotalAPagar);
		lblprsnlzdTotalAPagar.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblprsnlzdTotalAPagar.setText("Total a Pagar");

		lTotalPagar = new LabelPersonalizado(0);
		lTotalPagar.setBounds(970, 325, 120, 25);
		getContentPane().add(lTotalPagar);

		LabelPersonalizado lblprsnlzdGanancia = new LabelPersonalizado(0);
		lblprsnlzdGanancia.setBounds(970, 220, 81, 15);
		getContentPane().add(lblprsnlzdGanancia);
		lblprsnlzdGanancia.setVisible(false);
		lblprsnlzdGanancia.setText("Ganancia");

		lGanancia = new LabelPersonalizado(0);
		lGanancia.setBounds(970, 236, 120, 15);
		getContentPane().add(lGanancia);
		lGanancia.setVisible(false);
		lGanancia.setFont(new Font("Tahoma", Font.PLAIN, 12));

		LabelPersonalizado lblprsnlzdDescuento = new LabelPersonalizado(0);
		lblprsnlzdDescuento.setBounds(970, 262, 81, 15);
		getContentPane().add(lblprsnlzdDescuento);
		lblprsnlzdDescuento.setText("Descuento");

		tDescuentoPedido = new CampoNumeroPersonalizado();
		tDescuentoPedido.setBounds(970, 278, 120, 20);
		getContentPane().add(tDescuentoPedido);
		tDescuentoPedido.setFont(new Font("Tahoma", Font.PLAIN, 12));

		LabelPersonalizado lblprsnlzdSumatoria = new LabelPersonalizado(0);
		lblprsnlzdSumatoria.setBounds(970, 168, 81, 15);
		getContentPane().add(lblprsnlzdSumatoria);
		lblprsnlzdSumatoria.setText("Sumatoria");

		lSumatoria = new LabelPersonalizado(0);
		lSumatoria.setBounds(970, 184, 120, 15);
		getContentPane().add(lSumatoria);
		lSumatoria.setFont(new Font("Tahoma", Font.PLAIN, 12));
	...
	public TransaccionPedidoControlador getControlador() {
		return controlador;
	}
